...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["video"]) {
            ...
            echo "</small></p>
                    <div class=\"button-group\" style=\"display: flex; justify-content: space-between; align-items: center; margin-top: 20px; padding: 0 20px;\">
                        <a href=\"";
            // line 48
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_video_show", ["id" => twig_get_attribute($this->env, $this->source, $context["video"], "id", [], "any", false, false, false, 48)]), "html", null, true);
            echo "\" class=\"btn btn-primary\" style=\"padding: 10px 20px; border-radius: 5px; text-transform: uppercase; font-weight: bold; cursor: pointer; background-color: #4b49ab;\">Watch now</a>
                    </div>
                </div>
            </article>
            ";
            // line 52
            if ((0 == twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 52) % 3)) {
                // line 53
    ...
    <div class=\"pagination\">
        ";
        // line 63
        echo $this->extensions['Knp\Bundle\PaginatorBundle\Twig\Extension\PaginationExtension']->render($this->env, (isset($context["videos"]) || array_key_exists("videos", $context) ? $context["videos"] : (function () { throw new RuntimeError('Variable "videos" does not exist.', 63, $this->source); })()));
        echo "
    </div>
...
";
    ...
    {
        return array (  206 => 63,  199 => 58,  192 => 56,  179 => 55,  175 => 53,  173 => 52,  166 => 48,  161 => 46,  157 => 45,  153 => 44,  146 => 40,  142 => 38,  124 => 37,  119 => 34,  109 => 33,  69 => 3,  59 => 2,  36 => 1,);
    }
        ...
        {% for video in videos %}
            <article class=\"video-card\" style=\"display: inline-block; margin-right: 25px; margin-bottom: 20px; vertical-align: top; background-color: #333; color: #fff; border-radius: 10px;\">
                ...
                <div class=\"card-body\" style=\"padding: 20px;\">
                    ...
                    <div class=\"button-group\" style=\"display: flex; justify-content: space-between; align-items: center; margin-top: 20px; padding: 0 20px;\">
                        <a href=\"{{ path('app_video_show', {'id': video.id}) }}\" class=\"btn btn-primary\" style=\"padding: 10px 20px; border-radius: 5px; text-transform: uppercase; font-weight: bold; cursor: pointer; background-color: #4b49ab;\">Watch now</a>
                    </div>
                </div>
            </article>
