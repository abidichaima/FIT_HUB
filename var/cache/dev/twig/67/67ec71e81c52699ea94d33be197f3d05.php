...
class __TwigTemplate_d5536ad0a6c58decdcfcbd4e739e5158 extends Template
{
    private $source;
    private $macros = [];
        ...
        if ((twig_length_filter($this->env, (isset($context["participation_seances"]) || array_key_exists("participation_seances", $context) ? $context["participation_seances"] : (function () { throw new RuntimeError('Variable "participation_seances" does not exist.', 74, $this->source); })())) > 0)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["participationSeance"]) {
                ...
                echo "\">Show</a>
                             <a href=\"";
                // line 87
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_participation_seance_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["participationSeance"], "id", [], "any", false, false, false, 87)]), "html", null, true);
                echo "\">Delete</a>
                        </div>
                    </div>
                </div>
...
*";
    ...
    {
        return array (  216 => 95,  212 => 93,  209 => 92,  198 => 87,  194 => 86,  188 => 83,  183 => 81,  179 => 80,  175 => 79,  168 => 77,  165 => 76,  160 => 75,  158 => 74,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
