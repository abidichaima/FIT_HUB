    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo "                    </div>
                    <div class=\"card-body\">
                        <h2 class=\"card-title\">";
        // line 19
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["video"]) || array_key_exists("video", $context) ? $context["video"] : (function () { throw new RuntimeError('Variable "video" does not exist.', 19, $this->source); })()), "title", [], "any", false, false, false, 19), "html", null, true);
        echo "</h2>
                        <p class=\"card-text\">";
        // line 20
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["video"]) || array_key_exists("video", $context) ? $context["video"] : (function () { throw new RuntimeError('Variable "video" does not exist.', 20, $this->source); })()), "seance", [], "any", false, false, false, 20), "html", null, true);
        echo "</p>
                        <p class=\"card-text\">";
        // line 21
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["video"]) || array_key_exists("video", $context) ? $context["video"] : (function () { throw new RuntimeError('Variable "video" does not exist.', 21, $this->source); })()), "description", [], "any", false, false, false, 21), "html", null, true);
        echo "</p>
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["relatedVideos"]) || array_key_exists("relatedVideos", $context) ? $context["relatedVideos"] : (function () { throw new RuntimeError('Variable "relatedVideos" does not exist.', 29, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["relatedVideo"]) {
            // line 30
            echo "                        <li><a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_video_show", ["id" => twig_get_attribute($this->env, $this->source, $context["relatedVideo"], "id", [], "any", false, false, false, 30)]), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["relatedVideo"], "title", [], "any", false, false, false, 30), "html", null, true);
            echo "</a></li>
                        <li>
                            <video width=\"426\" height=\"240\" controls>
                                <source src=\"";
            // line 33
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("videos/" . twig_get_attribute($this->env, $this->source, $context["relatedVideo"], "video", [], "any", false, false, false, 33))), "html", null, true);
            echo "\" type=\"video/mp4\">
                                Your browser does not support the video tag.
                            </video>
                        </li>
...
";
    ...
    {
        return array (  165 => 44,  160 => 42,  154 => 38,  143 => 33,  134 => 30,  130 => 29,  119 => 21,  115 => 20,  111 => 19,  107 => 17,  100 => 13,  97 => 12,  95 => 11,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
            ...
            <div class=\"col-lg-4\">
                ...
                <ul class=\"list-unstyled\">
                    {% for relatedVideo in relatedVideos %}
                        <li><a href=\"{{ path('app_video_show', {'id': relatedVideo.id}) }}\">{{ relatedVideo.title }}</a></li>
                        <li>
                            <video width=\"426\" height=\"240\" controls>
