...
class __TwigTemplate_26f1b59dc43c6724f44340103525ac99 extends Template
{
    private $source;
    private $macros = [];
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["seance"]) {
                ...
                echo "                        <div class=\"card mb-5\">
                            <div class=\"card-body\">
                                <a href=\"";
                // line 18
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_seance_showBack", ["id" => twig_get_attribute($this->env, $this->source, $context["seance"], "id", [], "any", false, false, false, 18)]), "html", null, true);
                echo "\">
                                    <h2 class=\"card-title\">";
                // line 19
                ...
                echo "</small></p>
                            ...
                            <div class=\"card-footer text-muted d-flex justify-content-end\">
                                <a href=\"";
                // line 27
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_seance_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["seance"], "id", [], "any", false, false, false, 27)]), "html", null, true);
                ...
                {% else %}
                    {% for seance in seances %}
                        <div class=\"card mb-5\">
                            ...
                            <div class=\"card-footer text-muted d-flex justify-content-end\">
                                <a href=\"{{ path('app_seance_edit', {'id': seance.id}) }}\" class=\"btn btn-primary mr-2\">Edit</a>
