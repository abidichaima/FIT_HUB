 ...
 */
class getParticiationSeanceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ParticiationSeanceRepository' shared autowired service.
     *
     * @return \App\Repository\ParticiationSeanceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ParticiationSeanceRepository.php';

        return $container->privates['App\\Repository\\ParticiationSeanceRepository'] = new \App\Repository\ParticiationSeanceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
