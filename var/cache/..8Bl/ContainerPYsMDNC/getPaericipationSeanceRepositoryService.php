 ...
 */
class getPaericipationSeanceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PaericipationSeanceRepository' shared autowired service.
     *
     * @return \App\Repository\PaericipationSeanceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PaericipationSeanceRepository.php';

        return $container->privates['App\\Repository\\PaericipationSeanceRepository'] = new \App\Repository\PaericipationSeanceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
