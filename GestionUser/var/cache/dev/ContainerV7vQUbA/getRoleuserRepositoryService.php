 ...
 */
class getRoleuserRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RoleuserRepository' shared autowired service.
     *
     * @return \App\Repository\RoleuserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RoleuserRepository.php';

        return $container->privates['App\\Repository\\RoleuserRepository'] = new \App\Repository\RoleuserRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
