...
<div class=\"mt-5 mb-6 \">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 35
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 35, $this->source); })()), "roleuser", [], "any", false, false, false, 35), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
    ...
    <div class=\"my-2\">
                                    <a href=\"";
        // line 46
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_user_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 46, $this->source); })()), "id", [], "any", false, false, false, 46)]), "html", null, true);
        echo "\"  class=\"btn btn-success btn-icon-split\">
...
";
    ...
    {
        return array (  159 => 51,  151 => 46,  142 => 40,  134 => 35,  127 => 31,  120 => 27,  113 => 23,  105 => 18,  98 => 14,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"mt-5 mb-6 \">
    ...
    <div class=\"my-2\">
                                     <a href=\"{{ path('app_user_index') }}\"  class=\"btn btn-success btn-icon-split\">
                                      
                                        <span class=\"text\">back to list</span>
                                    </a>
                                    </div>
    <div class=\"my-2\">
                                    <a href=\"{{ path('app_user_edit', {'id': user.id})}}\"  class=\"btn btn-success btn-icon-split\">
...
{% endblock %}
", "user/show.html.twig", "C:\\Users\\Malek Ayedi\\Desktop\\GestionUser\\templates\\user\\show.html.twig");
    }
}
