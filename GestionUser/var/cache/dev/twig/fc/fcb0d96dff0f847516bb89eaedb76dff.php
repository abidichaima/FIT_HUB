...
<div class=\"mt-5 mb-6 \">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            echo "</td>
                <td>";
            // line 36
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "roleuser", [], "any", false, false, false, 36), "html", null, true);
            echo "</td>
                <td>
                 <div class=\"my-2\"></div>
                                    <a href=\"";
...
";
    ...
    {
        return array (  179 => 59,  173 => 55,  164 => 51,  152 => 44,  144 => 39,  138 => 36,  134 => 35,  130 => 34,  125 => 32,  121 => 31,  118 => 30,  113 => 29,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"mt-5 mb-6 \">
        ...
        {% for user in users %}
            <tr>
                ...
                <td>
                 <div class=\"my-2\"></div>
                                    <a href=\"{{ path('app_user_show', {'id': user.id}) }}\" class=\"btn btn-success btn-icon-split\">
    ...
    <div class=\"my-2\">
         <a href=\"{{ path('app_user_new') }}\" class=\"btn btn-success btn-icon-split\">
                                      
          <span class=\"text\">Create new</span>
        </a></div>
{% endblock %}
", "user/index.html.twig", "C:\\Users\\Malek Ayedi\\Desktop\\GestionUser\\templates\\user\\index.html.twig");
    }
}
