...
class Abonnement
{
    ...
    #[Assert\NotBlank(message:"saisir la date debut")]             
    #[ORM\Column(type: Types::DATE_MUTABLE)]
    #[Groups("abonnements")]
    private ?\DateTimeInterface $dateDebut = null;
    
    
    #[Assert\NotBlank(message:"saisir la date fin")]
    #[ORM\Column(type: Types::DATE_MUTABLE)]
    #[Groups("abonnements")]
    private ?\DateTimeInterface $dateFin = null;

    #[Assert\NotBlank(message:"saisir l'etat")]
    #[ORM\Column(length: 255)]
    #[Groups("abonnements")]
    ...
    #[Assert\NotBlank(message:"saisir le pack")]
