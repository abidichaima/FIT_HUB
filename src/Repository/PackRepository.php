...
//    }
    ...
    public function searchPack($data){
        $entityManager = $this->getEntityManager();
        $query = $entityManager->createQuery('SELECT p from App\Entity\Pack p where p.nomPack like :data OR p.dureePack like :data OR p.prixPack like :data ')->setParameter('data', '%'. $data.'%');
