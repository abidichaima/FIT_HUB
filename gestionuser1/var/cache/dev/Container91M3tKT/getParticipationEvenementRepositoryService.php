 ...
 */
class getParticipationEvenementRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ParticipationEvenementRepository' shared autowired service.
     *
     * @return \App\Repository\ParticipationEvenementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ParticipationEvenementRepository.php';

        return $container->privates['App\\Repository\\ParticipationEvenementRepository'] = new \App\Repository\ParticipationEvenementRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
