        ...
        <ul class=\"nav\">
          <li class=\"nav-item\">
            <a class=\"nav-link\" href=\"#\">
              ...
              <span class=\"menu-title\" tyle=\"margin-top:50px; padding:30px; width:800px; height:fit-content; 
       border-radius:60px;background-image: url('../image.jpg'); background-size:cover; box-shadow: -1px -1px 34px 3px rgba(0,0,0,0.63);
-webkit-box-shadow: -1px -1px 34px 3px rgba(0,0,0,0.63);-moz-box-shadow: -1px -1px 34px 3px rgba(0,0,0,0.63);\">Home</span>
        ...
        echo "\">Afficher Utilisateur</a></li>
          ...
          <li class=\"nav-item\">
            ...
            <div class=\"collapse\" id=\"icons\">
              <ul class=\"nav flex-column sub-menu\">
                <li class=\"nav-item\"> <a class=\"nav-link\" href=\"\">Ajouter Séance</a></li>
                <li class=\"nav-item\"> <a class=\"nav-link\" href=\"\">Afficher Séances</a></li>
                ...
                <li class=\"nav-item\"> <a class=\"nav-link\" href=\"\">Ajouter Vidéo</a></li>
                <li class=\"nav-item\"> <a class=\"nav-link\" href=\"\">Afficher Vidéos</a></li>
              </ul>
            </div>
          </li>
          <li class=\"nav-item\">
...
<head>
  ...
  <meta charset=\"utf-8\">
  <meta name=\"viewport\" content=\"width=device-width, initial-scale=1, shrink-to-fit=no\">
  <title>{% block title %} FitHub{% endblock %}</title>
  <!-- plugins:css -->
  {% block stylesheets %}
          ...
          <li class=\"nav-item nav-profile dropdown\">
            ...
            <div class=\"dropdown-menu dropdown-menu-right navbar-dropdown\" aria-labelledby=\"profileDropdown\">
              ...
              <a class=\"dropdown-item\">
                ...
                <i class=\"ti-power-off text-primary\"href=\"{{ path('app_back') }}\"></i>
                Logout
              </a>
            </div>
          </li>
        ...
        <div class=\"tab-content\" id=\"setting-content\">
          ...
          <div class=\"tab-pane fade\" id=\"chats-section\" role=\"tabpanel\" aria-labelledby=\"chats-section\">
            ...
            <ul class=\"chat-list\">
              ...
              <li class=\"list\">
                <div class=\"profile\"><img src=\"{{asset('./BackOffice/images/faces/face11.jpg')}}\" alt=\"image\"><span class=\"online\"></span></div>
                <div class=\"info\">
                  <p>Sarah Graves</p>
                  <p>Available</p>
                </div>
