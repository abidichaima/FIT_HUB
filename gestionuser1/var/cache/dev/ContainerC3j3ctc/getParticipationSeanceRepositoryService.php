 ...
 */
class getParticipationSeanceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ParticipationSeanceRepository' shared autowired service.
     *
     * @return \App\Repository\ParticipationSeanceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ParticipationSeanceRepository.php';

        return $container->privates['App\\Repository\\ParticipationSeanceRepository'] = new \App\Repository\ParticipationSeanceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
